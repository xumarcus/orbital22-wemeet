...
During the process, general webpage navigation, account authentication and scheduler functionality is tested. More specifically, we follow the user testing google forms which have detailed tasks such as creating a account, logging into an account, creating an event etc.